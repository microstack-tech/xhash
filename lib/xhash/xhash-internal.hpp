...
/// @file
/// Contains declarations of internal xhash functions to allow them to be
/// unit-tested.
...
extern "C" struct xhash_epoch_context_full : xhash_epoch_context
{
    xhash_hash1024* full_dataset;

    constexpr xhash_epoch_context_full(int epoch, int light_num_items, const xhash_hash512* light,
        int dataset_num_items, xhash_hash1024* dataset) noexcept
      : xhash_epoch_context{epoch, light_num_items, light, dataset_num_items},
